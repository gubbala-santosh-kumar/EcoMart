...
const Signup = () => {
  ...
  const handleSubmit = (e) => {
    ...
    alert('This is a demo signup form. No actual registration is performed.');
  };
        ...
        <div className="bg-white py-8 px-4 shadow-lg sm:rounded-2xl sm:px-10">
          ...
          <div className="mt-6 p-4 bg-blue-50 rounded-lg">
            <div className="flex">
              ...
              <div className="ml-3">
                <h3 className="text-sm font-medium text-blue-800">Demo Registration</h3>
                <p className="text-sm text-blue-700 mt-1">
                  This is a demonstration form. No actual account will be created.
                </p>
              </div>
            </div>
          </div>
